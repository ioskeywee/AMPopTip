...
- (UIBezierPath *)pathForContentWithRect:(CGRect)rect direction:(AMPopTipDirection)direction {
    ...
    switch (direction) {
        ...
        case AMPopTipDirectionDown: {
            baloonFrame = (CGRect){
                (CGPoint){ 1.f, self.arrowSize.height + self.borderWidth - 1.f},
                (CGSize){ rect.size.width - self.borderWidth * 2, rect.size.height - self.arrowSize.height - self.borderWidth * 2}
            };
            break;
        }
        ...
        case AMPopTipDirectionLeft: {
            ...
            baloonFrame = (CGRect){
                (CGPoint){ 1.f, 0.f},
                (CGSize){ rect.size.width - arrowSize.width - self.borderWidth * 4, rect.size.height - self.borderWidth * 2 - 1.f}
            };
            break;
        }
        ...
        case AMPopTipDirectionRight: {
            ...
            CGSize arrowSize = CGSizeMake(self.arrowSize.height, self.arrowSize.width);
            baloonFrame = (CGRect){
                (CGPoint){ arrowSize.width + self.borderWidth + 1.f, 1.f },
                (CGSize){ rect.size.width - arrowSize.width - self.borderWidth * 4, rect.size.height - self.borderWidth * 2 - 2.f}
            };
